...
namespace AmeisenBotX.Core.Dungeon.Profiles.WotLK
{
    public class UtgardeKeepProfile : IDungeonProfile
    {
        ...
        public List<DungeonNode> Path { get; private set; } = new List<DungeonNode>()
        {
            ...
            new DungeonNode(new Vector3(235, -319, 180), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(230, -313, 180), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(225, -307, 180), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(221, -300, 180), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(217, -293, 180), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(212, -287, 180), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(209, -280, 180), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(205, -273, 180), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(202, -266, 180), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(198, -259, 180), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(194, -252, 181), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(191, -245, 180), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(187, -238, 181), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(184, -231, 181), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(180, -224, 180), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(177, -217, 181), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(173, -210, 181), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(169, -203, 180), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(166, -196, 180), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(162, -189, 180), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(159, -181, 180), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(157, -173, 180), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(155, -165, 181), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(152, -158, 180), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(150, -150, 178), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(148, -143, 174), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(146, -136, 172), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(143, -129, 170), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(141, -119, 88), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(143, -127, 88), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(146, -134, 89), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(148, -141, 92), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(150, -148, 94), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(152, -158, 7), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(160, -156, 7), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(168, -154, 7), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(176, -152, 8), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(183, -150, 11), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(191, -149, 9), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(199, -150, 9), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(206, -147, 9), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(210, -140, 9), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(209, -132, 9), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(204, -125, 9), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(198, -119, 9), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(190, -117, 9), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(183, -116, 12), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(176, -112, 12), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(171, -106, 12), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(168, -99, 13), DungeonNodeType.Normal),
            new DungeonNode(new Vector3(165, -92, 13), DungeonNodeType.Normal),
        };
