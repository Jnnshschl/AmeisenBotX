...
namespace AmeisenBotX.Core.Quest.Profiles.StartAreas
{
    public class DeathknightStartAreaQuestProfile : IQuestProfile
    {
            ...
            (
                new List<BotQuest>()
                {
                    ...
                    (
                        ...
                        () => wowInterface.ObjectManager.GetClosestWowUnitQuestgiverByDisplayId(new List<int> { 24191 }),
                        () => wowInterface.ObjectManager.GetClosestWowUnitQuestgiverByDisplayId(new List<int> { 16582 }),
                        null
                    )
                }
            );
            ...
            (
                new List<BotQuest>()
                {
                    ...
                    (
                        ...
                        () => wowInterface.ObjectManager.GetClosestWowUnitQuestgiverByDisplayId(new List<int> { 24191 }),
                        () => wowInterface.ObjectManager.GetClosestWowUnitQuestgiverByDisplayId(new List<int> { 25444 }),
                        new List<IQuestObjective>()
                        {
                            new QuestObjectiveChain(new List<IQuestObjective>()
                            {
            ...
            (
                new List<BotQuest>()
                {
                    ...
                    (
                        ...
                        () => wowInterface.ObjectManager.GetClosestWowUnitQuestgiverByDisplayId(new List<int> { 25444 }),
                        () => wowInterface.ObjectManager.GetClosestWowUnitQuestgiverByDisplayId(new List<int> { 25496 }),
                        new List<IQuestObjective>()
                        {
            ...
            (
                new List<BotQuest>()
                {
                    ...
                    (
                        ...
                        () => wowInterface.ObjectManager.GetClosestWowUnitQuestgiverByDisplayId(new List<int> { 25496 }),
                        () => wowInterface.ObjectManager.GetClosestWowUnitQuestgiverByDisplayId(new List<int> { 25514 }),
                        new List<IQuestObjective>()
                        {
                            new QuestObjectiveChain(new List<IQuestObjective>()
                            {
            ...
            (
                new List<BotQuest>()
                {
                    ...
                    (
                        ...
                        new List<IQuestObjective>()
                        {
                            new QuestObjectiveChain(new List<IQuestObjective>()
                            {
                                ...
                                new KillUnitQuestObjective(wowInterface, new Dictionary<int, int> { { 0, 25506 }, { 1, 25509 }, { 2, 25555 }, { 3, 25558 }, { 4, 10311 }, { 5, 24573 }, { 6, 25504 } }, () => wowInterface.ObjectManager.Player.GetQuestlogEntries().FirstOrDefault(e => e.Id == 12678).X == 1)
                            })
                        }
                    ),
                    new BotQuest
                    (
                        ...
                        () => wowInterface.ObjectManager.GetClosestWowUnitQuestgiverByDisplayId(new List<int> { 16416 }),
                        () => wowInterface.ObjectManager.GetClosestWowUnitQuestgiverByDisplayId(new List<int> { 16416 }),
                        new List<IQuestObjective>()
                        {
                            new QuestObjectiveChain(new List<IQuestObjective>()
                            {
                                new MoveToPositionQuestObjective(wowInterface, new Vector3(2349, -5758, 154), 16.0),
                                new UseUnitQuestObjective(wowInterface, 237, false, () => wowInterface.ObjectManager.PetGuid > 0),
                                new BotActionQuestObjective(() => StolenPalomino = true),
                                new CastPetSpellQuestObjective(wowInterface, 52268, () => { if (CastedSpeedBuffPalomino) { return true; } else { CastedSpeedBuffPalomino = true; return false; }}),
                                new MoveToPositionQuestObjective(wowInterface, new Vector3(2340, -5687, 154), 16.0),
                                new MoveToUnitQuestObjective(wowInterface, 16416, 16.0),
                                new CastPetSpellQuestObjective(wowInterface, 52264, () => wowInterface.ObjectManager.PetGuid == 0)
                            })
                        }
                    ),
                    new BotQuest
                    (
                        ...
                        () => wowInterface.ObjectManager.GetClosestWowUnitQuestgiverByDisplayId(new List<int> { 25589 }),
                        () => wowInterface.ObjectManager.GetClosestWowUnitQuestgiverByDisplayId(new List<int> { 25589 }),
                        new List<IQuestObjective>()
                        {
                            new QuestObjectiveChain(new List<IQuestObjective>()
                    ...
                    (
                        ...
                        () => wowInterface.ObjectManager.GetClosestWowUnitQuestgiverByDisplayId(new List<int> { 26762 }),
                        () => wowInterface.ObjectManager.GetClosestWowUnitQuestgiverByDisplayId(new List<int> { 26762 }),
                        new List<IQuestObjective>()
                        {
                            new QuestObjectiveChain(new List<IQuestObjective>()
                            {
                                ...
                                new TalkToUnitQuestObjective(wowInterface, new List<int>(){ 25375, 25412, 25426, 25375 }, new List<int>() { 1 }, false, () => wowInterface.ObjectManager.Player.GetQuestlogEntries().FirstOrDefault(e => e.Id == 12733).X == 1)
                            })
                        }
                    ),
                    new BotQuest
                    (
                        ...
                        () => wowInterface.ObjectManager.GetClosestWowGameobjectQuestgiverByDisplayId(new List<int> { 4851 }),
                        () => wowInterface.ObjectManager.GetClosestWowUnitQuestgiverByDisplayId(new List<int> { 4851 }),
                        new List<IQuestObjective>()
                        {
                            new QuestObjectiveChain(new List<IQuestObjective>()
                            {
                                new MoveToPositionQuestObjective(wowInterface, new Vector3(2118, -5788, 98), 40.0),
                            })
                        }
                    ),
                }
        ...
        private bool CastedSpeedBuffPalomino { get; set; }
