...
namespace AmeisenBotX.Core.Combat.Classes.ToadLump
{
    public class Rogue : BasicCombatClass
    {
        ...
        public override IItemComparator ItemComparator { get; set; } = new BasicStrengthComparator(new List<WowArmorType>() { WowArmorType.LEATHER }, new List<WowWeaponType>() { WowWeaponType.ONEHANDED_SWORDS, WowWeaponType.ONEHANDED_MACES, WowWeaponType.DAGGERS });
