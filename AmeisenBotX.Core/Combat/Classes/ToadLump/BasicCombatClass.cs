    ...
    public abstract class BasicCombatClass : ICombatClass
    {
        ...
        public virtual void Execute()
        {
            ...
            if (TargetAuraManager.Tick(WowInterface.Target.Auras)
                || TargetInterruptManager.Tick(WowInterface.Objects.GetNearEnemies<WowUnit>(WowInterface.Db.GetReaction, WowInterface.Player.Position, IsMelee ? 5.0f : 30.0f).ToList()))
            {
                return;
            }
