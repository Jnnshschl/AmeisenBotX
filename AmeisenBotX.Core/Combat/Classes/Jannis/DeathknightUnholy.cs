        ...
        public override void Execute()
        {
            ...
            if (SelectTarget(TargetProviderDps))
            {
                ...
                if ((WowInterface.Player.HealthPercentage < 60
                        && TryCastSpellDk(iceboundFortitudeSpell, WowInterface.Target.Guid, true))
                    || TryCastSpellDk(bloodStrikeSpell, WowInterface.Target.Guid, false, true)
                    || TryCastSpellDk(scourgeStrikeSpell, WowInterface.Target.Guid, false, false, true, true)
                    || TryCastSpellDk(deathCoilSpell, WowInterface.Target.Guid, true)
                    || TryCastSpellDk(summonGargoyleSpell, WowInterface.Target.Guid, true)
