    ...
    public class DefaultCharacterManager : ICharacterManager
    {
        ...
        public bool IsAbleToUseWeapon(WowWeapon item)
        {
            return item?.WeaponType switch
            {
                ...
                WowWeaponType.Gun => Skills.Any(e => e.Key.Equals("Gun", StringComparison.OrdinalIgnoreCase) || e.Key.Equals("Schusswaffen", StringComparison.OrdinalIgnoreCase)),
                ...
                WowWeaponType.Dagger => Skills.Any(e => e.Key.Equals("Dagger", StringComparison.OrdinalIgnoreCase) || e.Key.Equals("Dolche", StringComparison.OrdinalIgnoreCase)),
                ...
                WowWeaponType.Staff => Skills.Any(e => e.Key.Equals("Staff", StringComparison.OrdinalIgnoreCase) || e.Key.Equals("Stäbe", StringComparison.OrdinalIgnoreCase)),
