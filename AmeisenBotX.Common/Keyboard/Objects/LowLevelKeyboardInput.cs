...
namespace AmeisenBotX.Common.Objects.Keyboard
{
    ...
    public struct LowLevelKeyboardInput
    {
        ...
        /// This member is specified as follows. An application can use the following values to
        /// test the keystroke Flags. Testing LLKHF_INJECTED (bit 4) will tell you whether the
        /// event was injected. If it was, then testing LLKHF_LOWER_IL_INJECTED (bit 1) will tell
